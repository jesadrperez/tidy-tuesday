...
hbcu_plot <- ggplot(gender_rc, aes(year, relative_change, color = gender)) +
  ...
  facet_grid(~gender) +
  labs(
    title = "HBCU Enrollment Is Unperdictable",
    subtitle = glue(
      'The relative change of enrollments for HBCU has been unperdictable for all students, <br>including ', 
      'black students, between 1976-2015.<br>', 
      '<b style="color:#9b938c">Overall</b> | ',
      '<b style="color:#d97400">Females</b> | ',
      '<b style="color:#4d33a2">Males</b>'
      ),
    y = NULL,
    x = NULL,
